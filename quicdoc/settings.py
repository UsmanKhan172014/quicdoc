"""
Django settings for QuicDoc project.
...
SECRET_KEY = env('SECRET_KEY', default='nUhvecmRcujdPJmLhOEYXNZVFwYlCgMltDSYKxkV')
...
WSGI_APPLICATION = 'quicdoc.wsgi.application'
...
if 'DATABASE_URL' in env:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': env('DJANGO_DATABASE_NAME', default='quicdoc'),
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'quicdoc_language'
LANGUAGES = [
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'QuicDoc',
    'DESCRIPTION': 'Software meant to save you time editing documents and allow you to spend more time bringing in customers',
    'VERSION': '0.1.0',
...
PROJECT_METADATA = {
    'NAME': gettext_lazy('QuicDoc'),
    'URL': 'http://localhost:8000',
    'DESCRIPTION': gettext_lazy("Software meant to save you time editing documents and allow you to spend more time bringing in customers"),
    'IMAGE': 'https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg',
    'KEYWORDS': 'SaaS, django',
    'CONTACT_EMAIL': 'frankabbondanza@gmail.com',
}

USE_HTTPS_IN_ABSOLUTE_URLS = False  # set this to True in production to have URLs generated with https instead of http

ADMINS = [('Frank', 'frankabbondanza@gmail.com')]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'quicdoc': {
            'handlers': ['console'],
            'level': env('QUICDOC_LOG_LEVEL', default='INFO'),
        }
    }
}
